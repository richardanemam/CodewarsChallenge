...
class CompleteChallengesAdapter(private val data: List<CompleteChallengesData>): RecyclerView.Adapter<CompleteChallengesAdapter.CompleteChallengesViewHolder>() {
